                ...
                <div class="flex justify-between -mb-px">
                    ...
                    <div class="hidden lg:flex">
                        <button type="button" class="appearance-none py-4 text-blue-dark border-b border-primary mr-6">
                            <a href="{{ route('mitra.pemesananPage') }}">{{ $pemesanans->no_po }}</a> &middot; Rekapitulasi
                ...
                <div
                    ...
                    <div id="purchase-order" class="max-w-5xl mx-auto p-6 bg-white shadow-md mt-10">
                        <header class="flex justify-between items-center mb-6">
                            <div>
                                <h1 class="text-2xl font-bold text-gray-800">{{ Auth::guard('mitra')->user()->name }}</h1>
                                <p class="text-sm text-gray-600">{{ Auth::guard('mitra')->user()->site }} - 10160</p>
                                <p class="text-sm text-gray-600">Mail: {{ Auth::guard('mitra')->user()->email }} Tlp:
                                    {{ Auth::guard('mitra')->user()->phone_number }}</p>
                            </div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="w-1/2">
                                    ...
                                    <p class="text-sm text-gray-600"><span class="font-bold">SHIP TO:</span>
                                        {{ Auth::guard('mitra')->user()->name }}</p>
                                    <p class="text-sm text-gray-600"> {{ Auth::guard('mitra')->user()->site }}</p>
                        ...
                        <footer class="mt-10">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-800 font-bold">{{ Auth::guard('mitra')->user()->name }}
                                    </p>
                                </div>
                                <div>
        ...
        document.getElementById('export-btn').addEventListener('click', function() {
            html2canvas(document.getElementById('purchase-order')).then(function(canvas) {
                canvas.toBlob(function(blob) {
                    ...
                    formData.append('image', blob, 'purchase_order.png');
