@extends('admin.layouts.main', [
    'title' => 'Pengusaha Kena Pajak | E-Faktur CV Sayovi Karyatama',
    'active' => 'Pengusaha Kena Pajak',
])
                ...
                <div class="flex justify-between -mb-px">
                    ...
                    <div class="hidden lg:flex">
                        <button type="button" class="appearance-none py-4 text-blue-dark border-b border-primary mr-6">
                            Rekapitulasi &middot; Data Pengusaha Kena Pajak
                        </button>
                    </div>
            ...
            <div class="flex items-center px-6 lg:hidden">
                <div class="flex-grow flex-no-shrink py-6">
                    <div class="text-grey-darker mb-2">
                        <span class="text-3xl align-top">PKP</span>
                        <span class="text-5xl">{{ $pkps->count() }}</span>
                    </div>
                </div>
            </div>
            <div class="hidden lg:flex">
                    ...
                    <div class="border-b">
                        <div class="flex justify-between px-6 -mb-px items-center gap-2">
                            <h3
                                ...
                                <i class='bx bxs-briefcase-alt-2 text-3xl'></i> Data Pengusaha Kena Pajak
                            </h3>
                            <div class="flex">
                            ...
                            @foreach ($pkps as $index => $pkp)
                                <tr class="transition-all hover:bg-[#f9f9f9]">
                                    ...
                                    <td class="px-6 py-4 uppercase flex gap-2">
                                        ...
                                        <form action="{{ route('admin.pengusaha.destroy', $pkp->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="px-6 py-6 lg:px-8">
                                                ...
                                                <form class="space-y-6"
                                                    action="{{ route('admin.pengusaha.update', $pkp->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
