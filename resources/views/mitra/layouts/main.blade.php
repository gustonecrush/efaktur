                    ...
                    <div class="flex items-center md:justify-between py-4">
                        ...
                        <div class="w-1/4 md:w-auto md:flex text-right">
                            ...
                            <div class="hidden md:block md:flex md:items-center ml-2">
                                <span class="text-white text-sm mr-1">{{ Auth::guard('mitra')->user()->name }}</span>
                                <div>
                ...
                <div class="container mx-auto px-4">
                    <div class="md:flex">
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="{{ route('mitra.pemesananPage') }}"
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="{{ route('mitra.invoicePage') }}"
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="{{ route('mitra.notaPage') }}"
                                ...
                                <i class='bx bxs-car text-lg'></i> <span>Nota Jalan</span>
                            </a>
                        </div>
