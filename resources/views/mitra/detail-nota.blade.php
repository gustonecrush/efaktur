                ...
                <div class="flex justify-between -mb-px">
                    ...
                    <div class="hidden lg:flex">
                        <button type="button" class="appearance-none py-4 text-blue-dark border-b border-primary mr-6">
                            <a href="{{ route('mitra.notaPage') }}">{{ $pemesanans->no_po }}</a> &middot;
                            Rekapitulasi
                            &middot; Nota Jalan Pemesanan
                        </button>
                    ...
                    <div id="purchase-order" class="max-w-5xl mx-auto p-6 bg-white shadow-md mt-10">
                        ...
                        <section class="mb-6">
                            <div class="flex justify-between">
                                <div class="w-1/2">
                                    <p class="text-sm text-gray-800 font-bold">TO: {{ $pemesanans->mitra->name }}</p>
                                    <p class="text-sm text-gray-600">{{ $pemesanans->mitra->site }}</p>
                                    <p class="text-sm text-gray-600">HP: {{ $pemesanans->mitra->phone_number }}</p>
                                    <p class="text-sm text-gray-600">Attn: {{ $pemesanans->received_by }}</p>
                                    <p class="text-sm text-gray-600">No PO: {{ $pemesanans->no_po }} </p>
