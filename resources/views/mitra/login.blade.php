            ...
            <div class="mt-32 px-12 sm:px-24 md:px-48 lg:px-12 xl:px-24 ">
                ...
                <div class="mt-12">
                    ...
                    <div class="mt-12 text-base font-display font-semibold text-gray-700 text-center">
                        Belum punya akun mitra ? <a href="{{ route('mitra.registerPage') }}"
                            class="cursor-pointer text-primary ">Register
                        </a>
                    </div>
                </div>
            </div>
