@extends('layouts.main', [
    'title' => 'Register Mitra CV Sayovi Karyatama',
])

@section('content')
    <div class="flex w-full">
        <div class="w-1/2">
            <div class="mt-24 px-12 sm:px-24 md:px-48 lg:px-12 xl:px-24 ">
                <h2
                    class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">
                    Register Mitra Pemesanan</h2>
                <div class="mt-12">
                    <form method="POST" action="{{ route('mitra.register') }}" autocomplete="off">
                        @csrf
                        @method('POST')
                        <div>
                            <div class="text-base font-medium text-gray-700 tracking-wide">Nama Perusahaan</div>
                            <input required
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary rounded-full"
                                type="text" name="name" placeholder="PT Bukit Asam Persero">
                        </div>

                        <div class="mt-5">
                            <div class="text-base font-medium text-gray-700 tracking-wide">Email Address</div>
                            <input required
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary rounded-full"
                                type="email" name="email" placeholder="company@gmail.com">
                        </div>
                        <div class="mt-5">
                            <div class="text-base font-medium text-gray-700 tracking-wide">Alamat Perusahaan</div>
                            <input required
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary rounded-full"
                                type="text" name="site" placeholder="Jl Buluran No. 1, Tanjung Enim, Muaara Enim">
                        </div>
                        <div class="mt-5">
                            <div class="text-base font-medium text-gray-700 tracking-wide">Nomor Telepon</div>
                            <input required
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary rounded-full"
                                type="text" name="phone_number" placeholder="(021) 0872413">
                        </div>
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                                <div class="text-base font-medium text-gray-700 tracking-wide">
                                    Password
                                </div>
                    ...
                    <div class="mt-12 text-base font-display font-semibold text-gray-700 text-center">
                        Sudah punya akun mitra ? <a href="{{ route('mitra.loginPage') }}"
                            class="cursor-pointer text-primary ">Login
                        </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex items-center justify-center bg-indigo-100 h-screen w-1/2">
            <div class="w-1/2 transform duration-200 hover:scale-110 cursor-pointer">
                <svg class="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72"
                    ...
                    <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#171d4e" />
                    ...
                    <polygon
                        ...
                        fill="#535461" />
                    <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#171d4e" />
                    <g opacity="0.1">
                    ...
                    <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
                        transform="translate(-335.6414 -100.11607)" fill="#171d4e" />
                    <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
